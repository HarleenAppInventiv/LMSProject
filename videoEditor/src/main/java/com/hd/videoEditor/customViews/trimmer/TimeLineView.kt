...
import com.hd.videoEditor.utils.BackgroundExecutor
import com.hd.videoEditor.utils.UiThreadExecutor
...
class TimeLineView @JvmOverloads constructor(
    ...
    override fun onSizeChanged(w: Int, h: Int, oldW: Int, oldH: Int) {
        ...
        if (w != oldW && mVideoUri != null) getBitmap(w)
    }
            ...
            override fun execute() {
                try {
                    ...
                    val frameWidth = (((initialBitmap?.width?.toFloat()
                        ?: 0f) / (initialBitmap?.height?.toFloat()
                        ?: 0f)) * frameHeight.toFloat()).toInt()
