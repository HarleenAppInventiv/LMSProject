...
public class GLPlumFilter extends GlFilter {
    ...
    private static final String FRAGMENT_SHADER =
            "precision mediump float;" +
                    ...
                    "   gl_FragColor.r = dot(FragColor.rgb, vec3(0.300, 0.400, 0.300));\n" +
                    "   gl_FragColor.g = dot(FragColor.rgb, vec3(0.600, 0.300, 0.500));\n" +
                    "   gl_FragColor.b = dot(FragColor.rgb, vec3(0.300, 1.000, 0.400));\n" +
                    "}";
