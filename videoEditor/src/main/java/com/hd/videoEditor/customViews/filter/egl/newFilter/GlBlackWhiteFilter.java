...
public class GlBlackWhiteFilter extends GlFilter {
    ...
    private static final String FRAGMENT_SHADER =
            "precision mediump float;" +
                    ...
                    "   gl_FragColor.r = dot(FragColor.rgb, vec3(0.700, 0.400, 0.300));\n" +
                    "   gl_FragColor.g = dot(FragColor.rgb, vec3(0.700, 0.400, 0.300));\n" +
                    "   gl_FragColor.b = dot(FragColor.rgb, vec3(0.700, 0.400, 0.300));\n" +
                    "}";
...
//                    "void main() {" +
//                    "   vec4 FragColor = texture2D(sTexture, vTextureCoord);\n" +
//                    "   gl_FragColor.r = dot(FragColor.rgb, vec3(0.300, 0.800, 0.500));\n" +
