...
class CompletedCourseFragment : BaseFragment<FragmentMyCourseBinding>(), BaseAdapter.IViewClick,
...
//        setHasOptionsMenu(true)
    ...
    private fun initUI() {
        ...
        binding.tvNoData.text = getString(R.string.no_complete_course_yet)
        binding.tvNoDataDesc.text =
            getString(R.string.you_dont_have_any_course_in_your_complete_list)
...
//        }
    ...
    private fun reset() {
        ...
        mAdapter = null
        viewModel.getCourses(CourseScreenType.COMPLETED_COURSES)
    }
