...
class InProgressFragment() : BaseFragment<FragmentInProgressBinding>(), BaseAdapter.IViewClick,
    ...
    private fun initUI() {
        ...
        mAdapter = null
        viewModel.courseType = ModeratorDashboard.INPROGRESS_FRAGMENT
...
//        viewModel.getCourses()
    ...
    private fun setAdapter() {
        ...
        if (viewModel.courseLiveData.value.isNullOrEmpty()) {
            ...
            mAdapter =
                LearnerDashAdapter(
                    (list ?: ArrayList()) as ArrayList<LearnerDashboardDataList>
                )
    ...
    override fun onItemClick(vararg items: Any) {
        ...
        when (type) {
            ...
            Constant.CLICK_BUYBUTTON, Constant.CLICK_VIEW -> {
                ...
                if (item?.userCourseStatus == CourseStatus.IN_PROGRESS
                ) {
