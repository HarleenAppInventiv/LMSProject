...
class CoAuthorCoursesLIstFragment() : BaseFragment<FragmentAuthorCoursesBinding>(),
    ...
    override fun onItemClick(vararg items: Any) {
        ...
        when (type) {
            ...
            Constant.CLICK_VIEW -> {
                var wishListItem =
                    viewModel.authorProfileCoursesLiveData.value?.get(position)
            ...
            Constant.CLICK_BUYBUTTON -> {
                ...
                if (wishListItem?.userCourseStatus == CourseStatus.ENROLLED || wishListItem?.userCourseStatus == CourseStatus.IN_PROGRESS
                    ...
                    when (wishListItem?.courseTypeId) {
                        CourseType.FREE -> {
                            viewModel.purchaseCoAuthorCourse()
                        }
                        CourseType.PAID -> {
                            CheckoutBottomSheet().apply {
                                ...
                                setOnDialogClickListener(this@CoAuthorCoursesLIstFragment)
