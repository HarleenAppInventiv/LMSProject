                ...
                Constant.CLICK_VIEW -> {
                    findNavController().navigateTo(
                        ...
                        bundleOf(
                            ...
                            "requestType" to ModHomeConst.REJECTED,
                            "id" to data.id
                        )
                    )
                }
...
//        binding.rvRequestedList.adapter = AdapterRequestList(ModeratorListType.REJECTED)
        ...
        viewModel.filterData.status = MODSTATUS.REJECTED
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.rejectCourse().observe(viewLifecycleOwner) {
