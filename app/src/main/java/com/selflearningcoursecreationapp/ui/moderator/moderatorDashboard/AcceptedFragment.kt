...
class AcceptedFragment() : BaseFragment<FragmentReviewedBinding>(), BaseAdapter.IViewClick,
    ...
    private fun initUI() {
        ...
        mAdapter = null
        viewModel.moderatorStatus = ModeratorDashboard.ACCEPTED_FRAGMENT
...
//        viewModel.getCourses()
    ...
    private fun setAdapter() {
        binding.rvReviewedList.visibleView(!viewModel.courseLiveData.value.isNullOrEmpty())
        ...
        if (viewModel.courseLiveData.value.isNullOrEmpty()) {
            ...
            mAdapter?.notifyDataSetChanged() ?: kotlin.run {
                ...
                binding.rvReviewedList.adapter = mAdapter
