...
class LMSAutoCompleteTextView : androidx.appcompat.widget.AppCompatAutoCompleteTextView {
    ...
    private fun initView(context: Context, attrs: AttributeSet? = null, defStyle: Int? = 0) {
        ...
        val themeAttrs = context.obtainStyledAttributes(
            attrs, R.styleable.LMSAutoCompleteTextView,
            defStyle!!, 0
        )

        val drawablePos =
            themeAttrs.getInt(
                R.styleable.LMSAutoCompleteTextView_primaryIconTint,
                ThemeConstants.TYPE_NONE
            )
        val drawableTintType =
            themeAttrs.getInt(
                R.styleable.LMSAutoCompleteTextView_drawableTintType,
        ...
        val fontType =
            themeAttrs.getInt(
                R.styleable.LMSAutoCompleteTextView_fontType,
                ThemeConstants.FONT_REGULAR
            )
        if (fontType > 0) {
        ...
        val textColorType =
            themeAttrs.getInt(
                R.styleable.LMSAutoCompleteTextView_textColorType,
        ...
        val textBgColor =
            themeAttrs.getInt(
                R.styleable.LMSAutoCompleteTextView_textBgColor,
                ThemeConstants.TYPE_NONE
            )
        val textBgMode =
            themeAttrs.getInt(
                R.styleable.LMSAutoCompleteTextView_textBgMode,
