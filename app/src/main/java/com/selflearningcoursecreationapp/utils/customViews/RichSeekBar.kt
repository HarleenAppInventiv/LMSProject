...
import com.selflearningcoursecreationapp.utils.richView.RichPathDrawable
...
abstract class RichSeekBar(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    fun setVectorDrawable(@DrawableRes resId: Int) {
        ...
        try {
            ...
            richPathDrawable = RichPathDrawable(vector, ImageView.ScaleType.FIT_XY, false)
            thumb = richPathDrawable
        } catch (e: IOException) {
            e.printStackTrace()
