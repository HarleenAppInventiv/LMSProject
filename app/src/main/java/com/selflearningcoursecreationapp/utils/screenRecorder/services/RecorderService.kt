...
import com.selflearningcoursecreationapp.utils.screenRecorder.FINISH_NOTIFICATION_CHANNEL_ID
import com.selflearningcoursecreationapp.utils.screenRecorder.MainActivity
import com.selflearningcoursecreationapp.utils.screenRecorder.RECORDING_NOTIFICATION_CHANNEL_ID
...
class RecorderService : Service() {
    ...
    private val pauseAction: NotificationCompat.Action
        get() {
            ...
            return NotificationCompat.Action(
                ...
                PendingIntent.getService(this, 0, pauseIntent, PendingIntent.FLAG_MUTABLE)
            )
        }
    ...
    private val openAppPendingIntent: PendingIntent
        get() {
            ...
            return PendingIntent.getActivity(this, 0, openAppIntent, PendingIntent.FLAG_MUTABLE)
        }
